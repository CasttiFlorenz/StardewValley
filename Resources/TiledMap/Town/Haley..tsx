...
<tileset version="1.4" tiledversion="1.4.3" name="Haley." tilewidth="16" tileheight="16" tilecount="96" columns="4">
 <image source="Pictures/Haley..png" width="64" height="384"/>
 <tile id="80">
  <animation>
