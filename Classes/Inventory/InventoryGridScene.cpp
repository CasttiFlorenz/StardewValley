...
void InventoryGridScene::initItem()
{
    ...
    // 放置初始工具
    _inventory[0] = Item("HOE", 1,1.5f,"/tools/hoe.png");
    _inventory[1] = Item("AXE",1,1.4f,"/tools/axe.png");
    _inventory[2] = Item("WATERING_CAN", 1,1.6f,"/tools/wateringCan.png");
    _inventory[3] = Item("PICKAXE", 1,1.4f,"/tools/pickaxe.png");
    _inventory[4] = Item("SCYTHE", 1,1.4f, "/tools/scythe.png");
}
