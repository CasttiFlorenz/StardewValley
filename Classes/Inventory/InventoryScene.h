...
public:
    ...
    void addItemCount(Objects object, int amount);         // 增加指定物品的数量
    void removeIetmCount(Objects object, int amount);      // 减少指定物品的数量
...
private:
    ...
    void showToolUseEffect(int selected);         // 显示工具使用特效
